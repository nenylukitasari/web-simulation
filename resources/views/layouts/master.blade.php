               ...
               <div class="col-sm-12">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            @if(Auth::check())
                            <a class="nav-link" href="#"><i class="fa fa- user"></i>Halo, {{ Auth::user()->nama }}</a>
                            <a class="nav-link" href="/logout"><i class="fa fa-power -off"></i>Logout</a>
                            @else
                            <a class="menu-icon fa fa-sign-in"></i><a href="#" data-target="#login" data-toggle="modal"> Masuk</a><br>
                            <a class="menu-icon fa fa-sign-out"></i><a href="#" data-target="#login" data-toggle="modal"> Logout</a>
                            @endif
                        </div>
                    </div>
                </div>
